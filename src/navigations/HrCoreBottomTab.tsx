...
import HrCoreReportsMainIndex from '../modules/arl-core-modules/hr-core/reports/HrCoreReportsMainIndex';
...
const HrCoreBottomTab = () => {
  ...
  return (
    <Navigator
      ...
      <Screen
        name="Report"
        component={HrCoreReportsMainIndex}
        options={{
          tabBarLabel: t('tab.report'),
          tabBarIcon: ({color, focused}) => (
            <Icon
