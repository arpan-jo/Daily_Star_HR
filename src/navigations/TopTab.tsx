...
import {
  ...
  MaterialTopTabNavigationProp} from '@react-navigation/material-top-tabs';
...
import {DrawerScreenProps, DrawerScreensParams} from './Drawer';
...
const {Navigator, Screen: _Screen} =
  createMaterialTopTabNavigator<TopTabScreensParams>();
...
const TopTabNavigator: React.FC<DrawerScreenProps<'TopTab'>> = ({
  navigation,
}) => {
  return (
    <ContainerNew edges={edges}>
      <CustomHeader
