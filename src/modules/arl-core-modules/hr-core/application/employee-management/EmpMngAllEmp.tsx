...
const EmpMngAllEmp = ({route}: props) => {
  ...
  useAsyncEffect(
    async isMounted => {
      ...
      const menuData = await getMenuData(leaveDetails?.UserId, setIsLoading);
...
export default EmpMngAllEmp;

export const empMngStyleCommon = StyleSheet.create({
  main: {
    paddingVertical: 24,
